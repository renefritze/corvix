...
notifications:
  ...
  web_push:
    ...
    subject: ""
  # Slack incoming-webhook delivery target (server-side, dispatched by the poller).
  slack:
    # Enable Slack delivery.
    enabled: false
    # Env var name holding the Slack incoming-webhook URL (also supports <VAR>_FILE).
