#!/usr/bin/env python
#
# https://github.com/renefritze/corvix documentation build configuration file, created by
...
version = corvix.__version__
# The full version, including alpha/beta/rc tags.
release = corvix.__version__
...
autoapi_dirs = [root_dir / "src" / "corvix"]
autoapi_type = "python"
...
def linkcode_resolve(domain: str, info: dict[str, str]) -> str | None:
    if domain == "py":
        ...
        baseurl = "https://github.com/renefritze/corvix"
