...
export function App() {
  ...
  const { snapshot, loading, refreshing, error, refresh } = useSnapshot(dashboard);
  ...
  const hasFilters = filters.unread !== "all" || filters.reason !== "" || filters.repository !== "";
    ...
    <div class="shell">
      ...
      {toastError && (
        <div class="error-toast" role="alert">
          {toastError}
          <button type="button" onClick={() => setToastError(null)}>✕</button>
        </div>
      )}
