import type { DashboardGroup, SortColumn, SortDirection, DashboardItem } from "../types";
import { TableHeader } from "./TableHeader";
import { TableRow } from "./TableRow";

function sortItems(items: DashboardItem[], col: SortColumn, dir: SortDirection): DashboardItem[] {
