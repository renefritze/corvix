      ...
      <tbody>
        {Array.from({ length: 9 }, (_, i) => (
          <tr key={i} class="skeleton-row">
            <td><span class="skeleton dot-skeleton" /></td>
            <td><span class="skeleton title-skeleton" /></td>
            <td><span class="skeleton repo-skeleton" /></td>
            <td class="hide-mobile"><span class="skeleton short-skeleton" /></td>
            <td class="hide-mobile"><span class="skeleton short-skeleton" /></td>
            <td><span class="skeleton score-skeleton" /></td>
