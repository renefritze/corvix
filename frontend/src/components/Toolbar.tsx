    ...
    <div class="toolbar-row">
      ...
      {summary && (
        <span class="inline-stats">
          {summary.unread_items + summary.read_items} notifications · {summary.unread_items} unread · {summary.repository_count} repos
        </span>
      )}
      <div class="toolbar-right">
        {dashboardNames.length > 1 && (
          <select
            ...
            onChange={(e) => onDashboardChange((e.target as HTMLSelectElement).value)}
