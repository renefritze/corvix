...
def test_group_header_remove_read_applies_to_visible_read(app_page: PageLike) -> None:
    ...
    expect(app_page.locator("tr.notification-row", has_text="Triage flaky integration test")).to_have_count(0)
    expect(app_page.locator("tr.notification-row", has_text="Review API changes")).to_have_count(1)
